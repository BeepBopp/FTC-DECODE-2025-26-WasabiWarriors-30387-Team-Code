...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 488.51349313820134; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2942.7909220595047; // x position of the perpendicular encoder (in tick units)
    }
